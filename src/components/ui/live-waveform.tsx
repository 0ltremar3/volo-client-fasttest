/**
 * Ondo UI LiveWaveform, adapted from ElevenLabs UI. MIT.
 * Source: https://ui.ondo.dou.so/r/live-waveform.json
 * Local changes: strict indexed access, promise handling, centered geometry.
 */
'use client'
    ...
    const frame = (currentTime: number) => {
      ...
      if (mode === 'static') {
        ...
        for (let i = 0; i < barCount && i < dataToRender.length; i++) {
          ...
          const x = (rect.width - (dataToRender.length * step - barGap)) / 2 + i * step
